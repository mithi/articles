...
The Context 
> The post circulated widely after a 2025 MIT Media Lab preprint (n=54) measured EEG during essay writing across four sessions. LLM users showed lower neural connectivity than the Brain-only and Search Engine groups. As a preprint, the findings are preliminary and not yet peer-reviewed.
